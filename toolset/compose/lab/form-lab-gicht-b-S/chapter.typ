...
// lab: gicht-2026-08-b · see comparison/matrix.md
...
#set document(title: "Gicht — Form Lab Pass S", author: "form-lab/gicht-2026-08-b/S")
#set page(
  paper: "a4",
...
#grid(
  ...
  column-gutter: 8pt,
  image("/domains/medical/assets/form-lab/gicht-2026-08-b/R/aspect-hot-mtp.jpg", width: 46mm),
  align(center + horizon)[#foot-mtp()],
  [
    #set text(size: 8.5pt)
    *Raster-Kachel (Pass R):* MTP-I Gestalt — Rötung/Schwellung als Erkennungsanker. \
