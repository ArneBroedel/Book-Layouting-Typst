...
// lab: melanom-abcde-2026-08 · pin: chapter-v-10-melanom-abcde-hautscreening.md

#import "/packages/bookkit/lib.typ": *
#import "@preview/fontawesome:0.6.1": fa-icon, fa-version
#fa-version("6")

#set document(title: "Melanom ABCDE — Form Lab Pass C", author: "form-lab/melanom-abcde-2026-08/C")
#set page(
  paper: "a4",
