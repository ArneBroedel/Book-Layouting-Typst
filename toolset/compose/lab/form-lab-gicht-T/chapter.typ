// Form Lab Pass T — Gicht · Typography + Icons (no panel-wall chrome)
// lab: gicht-2026-08 · content pin: Kursbuch5 chapter-v-3-gicht.md (read-only)

#import "/packages/bookkit/lib.typ": *
#import "@preview/fontawesome:0.6.1": fa-icon, fa-version
#fa-version("6") // fonts/ ships FA6

#set document(title: "Gicht — Form Lab Pass T", author: "form-lab/gicht-2026-08/T")
#set page(
  paper: "a4",
...
#text(size: 8.5pt)[
  Hochakute Monarthritis binnen Stunden, typischerweise MTP-I; starke Rötung/Überwärmung; bekannte Hyperurikämie oder frühere Attacken; passender Trigger — *ohne* schwere Systembedrohung.
]
...
#table(
  ...
  stroke: none,
  inset: (x: 0pt, y: 4pt),
  [#text(weight: "bold", size: 8.5pt, fill: palette.danger)[„Umgeknickt“]],
  ...
  [#text(weight: "bold", size: 8.5pt, fill: palette.danger)[„Nur Gicht-Schub“]],
  ...
  [#text(weight: "bold", size: 8.5pt, fill: palette.danger)[„Knie = Gicht“]],
...
#table(
  ...
  [#text(size: 10pt, weight: "bold", font: fonts.sans)[112]],
  ...
  [#text(size: 8.5pt, weight: "bold", font: fonts.sans)[NA gleichtags]],
  ...
  [#text(size: 8.5pt, weight: "bold", font: fonts.sans)[Zeitnah Arzt]],
...
#table(
  ...
  [
    #text(weight: "bold", size: 8.5pt)[Septische Arthritis]
    #linebreak()
    #text(size: 7pt, weight: "bold", fill: palette.danger)[Must-not-miss]
  ],
