// Form Lab Pass R — Schlaganfall · Raster atomic
// lab: schlaganfall-2026-08 · assets under domains/medical/assets/form-lab/schlaganfall-2026-08/R/

#import "/packages/bookkit/lib.typ": *
#import "@preview/fontawesome:0.6.1": fa-icon, fa-version
#fa-version("6")

#set document(title: "Schlaganfall — Form Lab Pass R", author: "form-lab/schlaganfall-2026-08/R")
#set page(
  paper: "a4",
  ...
  header: context {
    ...
    grid(columns: (1fr, auto), [Schlaganfall · Form Lab · Pass R (Raster atomic)], [viele kleine Atome · Typst-Text außerhalb])
...
#grid(
  ...
  column-gutter: 5pt,
  align(center)[
    #atom(A + "/atom-face-droop.jpg", w: 36mm, cap: [Atom F · Face / Mundwinkel])
  ],
  align(center)[
    #atom(A + "/atom-arm-drift.jpg", w: 36mm, cap: [Atom A · Arm-Drift])
  ],
  align(center)[
    #atom(A + "/atom-speech.jpg", w: 36mm, cap: [Atom S · Speech])
  ],
  align(center)[
    #atom(A + "/atom-clock.jpg", w: 36mm, cap: [Atom T · Time / 112])
  ],
)

#v(4pt)
#set text(size: 8.5pt)
*Claim-Audit (Atome):* Bilder zeigen *Gestalt* (Asymmetrie, Absinken, Sprachkontext, Zeitdruck) — sie *diagnostizieren* keinen Schlaganfall. FAST ≥ 1 mit plötzlichem Beginn → *112*. BE-FAST (Balance/Eyes) ergänzt Posterior-Kreislauf; FAST allein unempfindlich.
...
#grid(
  ...
  column-gutter: 6pt,
  atom(A + "/atom-face-droop.jpg", w: 28mm),
  atom(A + "/atom-speech.jpg", w: 28mm),
  text(size: 8.5pt)[
