// Form Lab Pass R — Anaphylaxie · Raster atomic
...
#set document(title: "Anaphylaxie — Form Lab Pass R", author: "form-lab/anaphylaxie-2026-08/R")
#set page(
  paper: "a4",
  ...
  header: context {
    ...
    grid(columns: (1fr, auto), [Anaphylaxie · Form Lab · Pass R], [Raster-Atome · Safety im Text])
...
#v(5pt)
#safety[Atemweg/Kreislauf/Progredienz → *sofort 112*. Bilder lehren Gestalt (Urtikaria, Angioödem, Kaskade) — sie ersetzen *kein* klinisches Screening und *kein* Notrufprotokoll.]
...
#grid(
  ...
  column-gutter: 6pt,
  align(center)[
    #atom(A + "/atom-urticaria.jpg", w: 42mm, cap: [Atom A · Urtikaria-Gestalt])
  ],
  align(center)[
    #atom(A + "/atom-angioedema.jpg", w: 42mm, cap: [Atom B · Angioödem-Gestalt])
  ],
  align(center)[
    #atom(A + "/atom-cascade.jpg", w: 42mm, cap: [Atom C · Kaskade-Konzept])
  ],
)

#v(4pt)
#set text(size: 8.5pt)
*Claim-Audit:* Atom A/B zeigen *kutanen* Gestalt-Eindruck — Fehlen von Hautzeichen schließt schwere Anaphylaxie *nicht* aus. Atom C ist Konzeptmetapher (Mediator-Kaskade), kein Messinstrument. Handlungsleitend: Atemwege und Kreislauf prüfen → bei kritischen Zeichen *112*.
...
#grid(
  ...
  column-gutter: 6pt,
  atom(A + "/atom-urticaria.jpg", w: 28mm),
  atom(A + "/atom-angioedema.jpg", w: 28mm),
  text(size: 8.5pt)[
