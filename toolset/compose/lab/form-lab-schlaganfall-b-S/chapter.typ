...
// lab: schlaganfall-2026-08-b · see comparison/matrix.md
...
#set document(title: "Schlaganfall — Form Lab Pass S", author: "form-lab/schlaganfall-2026-08-b/S")
#set page(
  paper: "a4",
...
#grid(
  ...
  column-gutter: 5pt,
  image(A + "/aspect-face-droop.jpg", width: 100%),
  image(A + "/aspect-arm-drift.jpg", width: 100%),
  image(A + "/aspect-speech.jpg", width: 100%),
