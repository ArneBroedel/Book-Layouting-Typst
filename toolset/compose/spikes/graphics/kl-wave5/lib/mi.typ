// Wave-5 · Myokardinfarkt / ACS — nested multi-T1 + mimic + discrimination
// Form Specs: kl-mi-urgency · kl-mi-mimic · (FA/NM from content-map)
...
// ── U-urgency + U-scope (US-B nested multi-T1, 4 clusters) ────
