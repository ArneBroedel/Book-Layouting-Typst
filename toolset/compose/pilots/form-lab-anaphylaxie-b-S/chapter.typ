...
#set document(title: "Anaphylaxie — Form Lab Pass S", author: "form-lab/anaphylaxie-2026-08-b/S")
#set page(
  paper: "a4",
...
#grid(
  ...
  column-gutter: 6pt,
  image(A + "/aspect-urticaria.jpg", width: 38mm),
  image(A + "/aspect-angioedema.jpg", width: 38mm),
