...
#set document(title: "Melanom ABCDE — Form Lab Pass R", author: "form-lab/melanom-abcde-2026-08-b/R")
#set page(
  paper: "a4",
  ...
  header: context {
    ...
    grid(columns: (1fr, auto), [Melanom/ABCDE · Form Lab · Pass R], [Raster-Kacheln · Claims im Text])
...
#let A = "/domains/medical/assets/form-lab/melanom-abcde-2026-08-b/R"
...
#grid(
  ...
  column-gutter: 10pt,
  align(center)[
    #atom(A + "/aspect-lesion.jpg", w: 58mm, cap: [Kachel A · suspekte Pigmentläsion (Gestalt)])
  ],
  align(center)[
    #atom(A + "/aspect-lesion-multitone.jpg", w: 58mm, cap: [Kachel B · Mehrtonigkeit (Kriterium C-Gestalt)])
  ],
)

#v(4pt)
#set text(size: 8.5pt)
*Claim-Audit:* Kachel A zeigt eine *beispielhafte* suspekte Gestalt — nicht „dieses Melanom“. Kachel B visualisiert ABCDE-Kriterien als Lernhilfe; endgültige Einordnung ist *ärztlich/histologisch*. Ugly Duckling: die Läsion, die *anders* ist als die übrigen.
...
#grid(
  columns: (auto, 1fr),
  column-gutter: 8pt,
  atom(A + "/aspect-lesion.jpg", w: 36mm),
  text(size: 8.5pt)[
