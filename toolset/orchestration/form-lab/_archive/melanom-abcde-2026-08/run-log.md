...
## Pass S synthesis
- r1 BUILD from matrix winners only → PNG `dist/form-lab/melanom-abcde-2026-08/S/p1–p2.png`
- r1 CRITIQUE: blank pages time-tier bug
...
## 2026-08-02 densify fix (skeptic C p3 / orphan pages)
- Pass C: collapsed merksatz-only p3 → 2 filled pages (case+DDx+merksatz on last page)
- PNG re-export; critiques r01–r03 rewritten from re-read images
- verify gate: last-page content_end ≥ 0.50 for multi-page sets

## Pass T densify
- p2 filled with DDx + type TIME + Grenze after orphan case page
