...
|---|---|---|
| Gicht | `gicht-2026-08-o` | `toolset/compose/lab/form-lab-gicht-o/` |
| Melanom ABCDE | `melanom-abcde-2026-08-o` | `toolset/compose/lab/form-lab-melanom-abcde-o/` |
| Anaphylaxie | `anaphylaxie-2026-08-o` | `toolset/compose/lab/form-lab-anaphylaxie-o/` |
| Schlaganfall | `schlaganfall-2026-08-o` | `toolset/compose/lab/form-lab-schlaganfall-o/` |
...
for ch in gicht melanom-abcde anaphylaxie schlaganfall; do
  typst compile --root . --ignore-system-fonts --font-path fonts \
    toolset/compose/lab/form-lab-${ch}-o/chapter.typ \
