...
| **Publishing-roles + boundaries (active)** | `CONSENSUS-v0`, `PRODUCT-BOUNDARIES` v0.3 (ADR 50–59), archived platform-boundaries | **C** content / **B** media / **A** print layout / **W** web (Grenzvertrag); Freeze → Accept → A‖W. |
