...
#block(
  ...
  radius: 10pt,
  inset: 14pt,
  stroke: (paint: rgb("#c7cbe1"), thickness: 0.8pt),
)[
  #text(weight: 800)[Fallvignette (Kurzform)]
  #v(6pt)
...
#zebra-table(
  columns: (1fr, 1fr, 1fr),
  [Merkmal], [Mechanisch], [Entzündlich],
  [Morgensteifigkeit], [kurz (< 30 min)], [lang (> 30–60 min)],
  [Belastung], [schlechter], [besser],
  [Ruhe], [besser], [schlechter],
  [NSAID], [variabel], [oft deutlich]
)
