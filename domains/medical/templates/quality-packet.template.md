...
- **assembled_by:** (role: AX or studio host — **not** sole builder of all units)
...
- [ ] Every non-prose unit has Design Contract  
- [ ] Every unit: Design Critic status **clean** (or Human waiver noted)  
- [ ] Every graphic unit: Visual Critic status **clean** on **latest** PNG set  
...
- [ ] **yes** — Design CLEAN + Visual CLEAN  
- [ ] **no** — blockers:

## Human gate

- [ ] H-Design (if residual design blocks / budget exhaust)  
- [ ] H-Explore or production H2  
- [ ] H-Gfx if anatomy/risk assets  
